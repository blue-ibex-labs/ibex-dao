...
function createTSPlugin(modules) {
    ...
    function create(info) {
        ...
        const isPageFile = (filePath)=>{
            return filePath.startsWith(appDir) && /^page\.(mjs|js|jsx|ts|tsx)$/.test(_path.default.basename(filePath));
        };
        ...
        proxy.getSemanticDiagnostics = (fileName)=>{
            ...
            if (!isAppEntryFile(fileName)) return prior;
            const source = (ref7 = info.languageService.getProgram()) == null ? void 0 : ref7.getSourceFile(fileName);
            if (source) {
                let isClientEntry = false;
                try {
